...
direct_feature_key = ['stroke_red', 'stroke_green', 'stroke_blue', 'fill_red', 'fill_green', 'fill_blue',                      'fill_opacity', 'stroke_opacity', 'stroke_width', 'cx', 'cy', 'area', 'dx', 'dy', 'length',                      'num_vertex', 'delta_x', 'delta_y', 'feature_trend_0', 'feature_trend_1', 'feature_trend_2',                      'feature_trend_3', 'feature_trend_4']
...
input_path = "../full_VizML+/train_json"
output_path = "../full_VizML+/train_graph"
